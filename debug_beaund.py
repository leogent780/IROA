...
def main():
    ...
    # Review/list API — 쿠키 포함 테스트
    print("\n=== /Review/list API (쿠키 포함) 테스트 ===")
    print(f"보유 쿠키: {list(captured['cookies'].keys())}")
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/124.0.0.0 Safari/537.36",
        "Referer": "https://sfre-srcs-service.snapfit.co.kr/",
        "Origin": "https://sfre-srcs-service.snapfit.co.kr",
    }
    for pg in [1, 2]:
        resp = requests.get(
